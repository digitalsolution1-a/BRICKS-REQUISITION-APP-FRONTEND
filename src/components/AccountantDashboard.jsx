                  ...
                  <div className="p-8 flex flex-col md:flex-row justify-between items-center gap-8">
                    ...
                    <div className="flex items-center gap-8">
                       <div className="text-right">
                          ...
                          <p className="text-2xl font-black text-gray-900">{getMDApprovedAmount(req.approvalHistory, req.amount, req.currency)}</p>
                       </div>
                       <button 
              ...
              {filterList(allDepartments).map(req => (
                <div key={req._id} className="bg-white p-6 rounded-[2.5rem] border border-gray-100 shadow-sm flex justify-between items-center hover:shadow-md transition-all animate-in slide-in-from-top-2">
                  <div>
                    ...
                    <p className="text-base font-black text-[#A67C52] leading-none mt-1">{getMDApprovedAmount(req.approvalHistory, req.amount, req.currency)}</p>
                  </div>
                  <button 
            ...
            <div className="p-8 md:p-12 overflow-y-auto max-h-[90vh]">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <div className="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                  ...
                  <p className="text-[11px] font-black text-[#A67C52]">{getMDApprovedAmount(selectedReq.approvalHistory, selectedReq.amount, selectedReq.currency)}</p>
                </div>
              </div>
